        ...
        <nav className='flex md:mx-10 mx-2 my-2 w-full'>
            ...
            <div className='md:mx-10 md:flex justify-center items-center hidden'>
                ...
                }
                {
                    !isAdmin &&
                    <>
                        <Link href={"/auction/ongoingauction"} className='mx-5 text-lg font-bold text-white  bg-[#A3A4A1] rounded-3xl px-5 py-1'>Auction</Link>
            ...
            <div className='ml-auto md:mx-2 flex'>
